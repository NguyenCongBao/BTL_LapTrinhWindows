...
namespace QuanLyThuVien_GUI
{
    ...
    public partial class QuanLyDocGia_GUI : Form
    {
        ...
        public void LoadData()
        {
            ...
            cbGioiTinh.DataSource = docgia.ShowDocGia();
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    ...
                    if (cbGioiTinh.SelectedValue.ToString().Equals("Nu"))
                        x = x && false;
                    docgia.UpdateDocGia(txtMaDG.Text, txtTenDG.Text, x, txtNgaySinh.Text, cbMaDT.SelectedValue.ToString(), txtNgayCap.Text, txtNgayHetHan.Text);
        ...
        private void dgvQuanLyTaiLieu_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
           ...
           txtTenDG.Text = dgvQuanLyTaiLieu.Rows[dong].Cells[1].Value.ToString();
            cbGioiTinh.SelectedValue = dgvQuanLyTaiLieu.Rows[dong].Cells[3].Value.ToString();
           txtNgaySinh.Text = dgvQuanLyTaiLieu.Rows[dong].Cells[4].Value.ToString();
            cbMaDT.SelectedValue = dgvQuanLyTaiLieu.Rows[dong].Cells[2].Value.ToString();
